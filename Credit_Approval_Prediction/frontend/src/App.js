...
import UserManagement from './pages/UserProfile/UserProfiles';
          ...
          <div className="row">
            <div className="col-md-9">
              <Routes>
                ...
                <Route path="/userprofile" element={<UserManagement results={results} onLogin={handleLogin} username={loggedInUsername}  userRole={userRole}/>} />
                <Route path="/Profile" element={<Profile setResults={setResults}/>} /> {/* Add this line */}
                <Route path="/settings" element={<Settings setResults={setResults}/>} />
